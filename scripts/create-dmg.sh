#!/usr/bin/env bash
# create-dmg.sh
# Creates a signed, customized DMG for MiniCalendar with background image and icon layout.
# Adapted from https://github.com/tw93/MiaoYan
#
# Usage:
#   ./scripts/create-dmg.sh <path-to-MiniCalendar.app> <version> <signing-identity>
#
# Example:
#   ./scripts/create-dmg.sh \
#     ~/Library/Developer/Xcode/DerivedData/.../Release/MiniCalendar.app \
#     1.2.3 \
#     "Developer ID Application: Your Name (TEAMID)"

set -euo pipefail

APP_PATH="${1:?Usage: $0 <path-to-MiniCalendar.app> <version> <signing-identity>}"
